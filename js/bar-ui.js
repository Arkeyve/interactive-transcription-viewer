...
(function(window) {
  ...
  Player = function(playerNode) {
    ...
    actions = {
      ...
      // create a function for playing from a position
      playFrom: function(seekPos) {
        if(soundObject && soundObject.duration) {
          // ms to seconds
          if(soundObject.playState == 0 || soundObject.paused) {
            window.sm2BarPlayers[0].actions.play();
          }
          soundObject.setPosition(seekPos * 1000);
        } else {
          window.sm2BarPlayers[0].actions.play();
          soundObject.setPosition(seekPos * 1000);
        }
      ...
      getCurrentTime: function() {
        if(soundObject && soundObject.position) {
          return soundObject.position;
        } else {
          return 0;
        }
      },
      ...
      isPaused: function() {
        if(soundObject && soundObject.paused) {
          return true;
        } else {
          return false;
        }
